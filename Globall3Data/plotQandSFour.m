function plotQandS(Shear,Qm1,Period,x,J2logtheta,resnorm,m,n,b)
...
Period=log10(Period);
 plot(Period1,Qm1fit(:,No), 'red',Period((1+j):(j+r)), Qm1((1+j):(j+r)),'red o','MarkerFaceColor','r');hold on
%  ax1=ax.ydirection;
ax=gca;
ax.TickDir='out';
 
 plot(Period1,Qm1fit(:,(No+1)), 'color',rgb('orange'));hold on
 plot(Period((1+j+r):(j+2*r)), Qm1((1+j+r):(j+2*r)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
 plot(Period1,Qm1fit(:,(No+2)), 'g',Period((1+j+2*r):(j+3*r)), Qm1((1+j+2*r):(j+3*r)),'g o','MarkerFaceColor','g');hold on
 plot(Period1,Qm1fit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r)), Qm1((1+j+3*r):(j+4*r)),'blue o','MarkerFaceColor','b');hold on
...
r=10; % number of periods
j=40; %bottom
 plot(Period1,Qm1fit(:,(No+0)), 'red',Period((1+j):(j+r)), Qm1((1+j):(j+r)),'red o','MarkerFaceColor','r');hold on
 ax=gca;
ax.TickDir='out';
 plot(Period1,Qm1fit(:,(No+1)), 'color',rgb('orange'));hold on
 plot(Period((1+j+r):(j+2*r)), Qm1((1+j+r):(j+2*r)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
...
ax.TickDir='out';
 ...
 plot(Period((1+j+r):(j+2*r)), Qm1((1+j+r):(j+2*r)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
 plot(Period1,Qm1fit(:,(No+2)), 'g',Period((1+j+2*r):(j+3*r)), Qm1((1+j+2*r):(j+3*r)),'g o','MarkerFaceColor','g');hold on
 plot(Period1,Qm1fit(:,(No+3)), 'blue',Period((1+j+3*r):(116)), Qm1((1+j+3*r):(116)),'blue o','MarkerFaceColor','b');hold on
...
r=10; % number of periods
j=116; %bottom
plot(Period1,Qm1fit(:,(No+0)), 'red',Period((1+j):(j+r-1)), Qm1((1+j):(j+r-1)),'red o','MarkerFaceColor','r');hold on
 ax=gca;
ax.TickDir='out';
 plot(Period1,Qm1fit(:,(No+1)), 'color',rgb('orange'));hold on
 plot(Period((j+r):(j+2*r-3-1)), Qm1((j+r):(j+2*r-3-1)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
 plot(Period1,Qm1fit(:,(No+2)), 'g',Period((j+2*r-2-1):(j+3*r-3-1)), Qm1((j+2*r-2-1):(j+3*r-3-1)),'g o','MarkerFaceColor','g');hold on
 plot(Period1,Qm1fit(:,(No+3)), 'blue',Period((j+3*r-2-1):(end)), Qm1((j+3*r-2-1):(end)),'blue o','MarkerFaceColor','b');hold on
 title(['M3356', ' (background+peak)'])
xlabel('period (s)')
ylabel(m)
ylim([-2.5 0])
...
r=10; % number of periods
j=0; %bottom
plot(Period1,Shearfit(:,No), 'red',Period((1+j):(j+r)), Shear((1+j):(j+r)),'red o','MarkerFaceColor','r');hold on
 plot(Period1,Shearfit(:,(No+1)),'color', rgb('orange'));hold on
 plot(Period((1+j+r):(j+2*r)), Shear((1+j+r):(j+2*r)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
  plot(Period1,Shearfit(:,(No+2)), 'g',Period((1+j+2*r):(j+3*r)), Shear((1+j+2*r):(j+3*r)),'g o','MarkerFaceColor','g');hold on
  plot(Period1,Shearfit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r)), Shear((1+j+3*r):(j+4*r)),'blue o','MarkerFaceColor','b');hold on
 title(['M2817', ' (background+peak)'])
xlabel('period (s)')
ylabel(n)
ylim([0 up])
...
plot(Period1,Shearfit(:,No), 'red',Period((1+j):(j+r)), Shear((1+j):(j+r)),'red o','MarkerFaceColor','r');hold on
 ...
 plot(Period((1+j+r):(j+2*r)), Shear((1+j+r):(j+2*r)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
  plot(Period1,Shearfit(:,(No+2)), 'g',Period((1+j+2*r):(j+3*r)), Shear((1+j+2*r):(j+3*r)),'g o','MarkerFaceColor','g');hold on
  plot(Period1,Shearfit(:,(No+3)), 'blue',Period((1+j+3*r):(116)), Shear((1+j+3*r):(116)),'blue o','MarkerFaceColor','b');hold on
 title(['M3093', ' (background+peak)'])
xlabel('period (s)')
ylabel(n)
ax=gca;
...
r=10; % number of periods
j=116; %bottom
plot(Period1,Shearfit(:,No), 'red',Period((1+j):(j+r-1)), Shear((1+j):(j+r-1)),'red o','MarkerFaceColor','r');hold on
 plot(Period1,Shearfit(:,(No+1)),'color', rgb('orange'));hold on
 plot(Period((j+r):(j+2*r-3-1)), Shear((j+r):(j+2*r-3-1)),'o','color',rgb('orange'),'MarkerFaceColor',rgb('orange')); hold on
  plot(Period1,Shearfit(:,(No+2)), 'g',Period((j+2*r-2-1):(j+3*r-3-1)), Shear((j+2*r-2-1):(j+3*r-3-1)),'g o','MarkerFaceColor','g');hold on
  plot(Period1,Shearfit(:,(No+3)), 'blue',Period((j+3*r-2-1):(end)), Shear((j+3*r-2-1):(end)),'blue o','MarkerFaceColor','b');hold on
 title(['M3356', ' (background+peak)'])
xlabel('period (s)')
ylabel(n)
ax=gca;
