function AfigureplotJ2(J2,Period,x,J2theta,resnorm,m,b)
...
r=10; % number of periods
j=148; %bottom
 semilogx(Periodfit,J2logfit(:,1), 'red',Period((1+j):(j+r)), J2((1+j):(j+r)),'red o');hold on
 semilogx(Periodfit,J2logfit(:,2), 'magenta', Period((1+j+r):(j+2*r)), J2((1+j+r):(j+2*r)),'magenta o');hold on
 semilogx(Periodfit,J2logfit(:,3), 'green',Period((1+j+2*r):(j+3*r)), J2((1+j+2*r):(j+3*r)),'green o');hold on
%  semilogx(Periodfit,J2logfit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r-4)), J2((1+j+3*r):(j+4*r-4)),'blue o');hold on
