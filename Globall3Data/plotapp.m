function plotapp(app,J2,Period,x,m)
...
Waterfit=repmat([repmat(143,[1,4]) repmat(77,[1,4]) repmat(9,[1,4]) repmat(25,[1,4])]',[1,71]);
 Grainfit=repmat([repmat(12,[1,4]) repmat(11,[1,4]) repmat(6.0,[1,4]) repmat(6.0,[1,4])]',[1,71]);
%  Xfit=repmat(x,[16,1]);
...
j=40; %bottom
 ...
 semilogx(app.UIAxes2,Periodfit,J2logfit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r)), J2((1+j+3*r):(j+4*r)),'blue o')
  hold (app.UIAxes2,'on')
 title(app.UIAxes2,['M2863', ' (background+peak)'])
xlabel(app.UIAxes2,'period (s)')
ylabel(app.UIAxes2,m)
axis(app.UIAxes2,[1e-2 1e4 -10 -2])
...
j=80; %bottom
 ...
 hold (app.UIAxes3,'on')
 semilogx(app.UIAxes3,Periodfit,J2logfit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r-4)), J2((1+j+3*r):(j+4*r-4)),'blue o')
 hold (app.UIAxes3,'on')
 title(app.UIAxes3,['M3093', ' (background+peak)'])
xlabel(app.UIAxes3,'period (s)')
ylabel(app.UIAxes3,m)
axis(app.UIAxes3,[1e-2 1e4 -10 -2])
...
j=116; %bottom
 ...
 semilogx(app.UIAxes4,Periodfit,J2logfit(:,(No+2)), 'green',Period((1+j+2*r):(j+3*r)), J2((1+j+2*r):(j+3*r)),'green o')
  hold (app.UIAxes4,'on')
 semilogx(app.UIAxes4,Periodfit,J2logfit(:,(No+3)), 'blue',Period((1+j+3*r):(j+4*r)), J2((1+j+3*r):(j+4*r)),'blue o')
  hold (app.UIAxes4,'on')
 title(app.UIAxes4,['M2810', ' (background+peak)'])
xlabel(app.UIAxes4,'period (s)')
ylabel(app.UIAxes4,m)
axis(app.UIAxes4,[1e-2 1e4 -10 -2])
